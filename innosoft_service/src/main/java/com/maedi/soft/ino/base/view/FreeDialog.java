...
public class FreeDialog<T> extends Dialog {
    ...
    {
        void setView(View view, FreeDialog dialog);
    }
    ...
    public static class BuilderFreeDialog{
        ...
        private int styleAnimation = R.style.DialogDefaultAnimation;
        ...
        switch (layout)
        {
            case CUSTOM_LAYOUT:
                ...
                else
                {
                    ...
                    if(null != listener)listener.setView(view, this);
                }
                break;
            case DEFAULT:
                view = inflater.inflate(R.layout.dialog_default_style, container);
                ...
                TextView bdText = (TextView) view.findViewById(R.id.body_text);
                bdText.setText(null == bodyText ? "" : bodyText);

                LinearLayout ok = (LinearLayout) view.findViewById(R.id.yes);
                TextView textOk = (TextView) view.findViewById(R.id.text_yes);
                ...
                LinearLayout cancel = (LinearLayout) view.findViewById(R.id.not);
                TextView textNot = (TextView) view.findViewById(R.id.text_not);
                ...
                {
                    LinearLayout defaulButtonLayout = (LinearLayout) view.findViewById(R.id.default_button_layout);
